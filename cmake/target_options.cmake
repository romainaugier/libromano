...
function(set_target_options target_name)
    if(CMAKE_C_COMPILER_ID STREQUAL "Clang")
        ...
        target_compile_options(${target_name} $<$<CONFIG:Debug>:-O0 -fsanitize=leak -fsanitize=address>)
        target_compile_options(${target_name} $<$<CONFIG:Release,RelWithDebInfo>:-O3 -march=native>)
    elseif (CMAKE_C_COMPILER_ID STREQUAL "GNU")
        set(ROMANO_GCC 1)
        set(CMAKE_C_FLAGS "-D_FORTIFY_SOURCES=2 -pipe -Wall -pedantic-errors")

        target_compile_options(${target_name} $<$<CONFIG:Debug>:-O0 -fsanitize=leak -fsanitize=address>)
        target_compile_options(${target_name} $<$<CONFIG:Release,RelWithDebInfo>:-O3 -ffast-math -march=native -ftree-vectorizer-verbose=2>)
