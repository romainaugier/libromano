...
ROMANO_FORCE_INLINE uint64_t murmur_64(uint64_t h)
{
    h ^= h >> 33;
...
ROMANO_FORCE_INLINE uint32_t random_uint32_range(const uint32_t state, const uint32_t low, const uint32_t high)
{
